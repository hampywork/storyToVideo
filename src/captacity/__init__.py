...
def add_captions(
    ...
    if pre_generated_captions is None:
        if print_info:
        ...
        segments = pre_generated_captions
    ...
    # Create CompositeVideoClip with audio from the original video
    video_with_text = CompositeVideoClip(clips).set_audio(video.audio)
